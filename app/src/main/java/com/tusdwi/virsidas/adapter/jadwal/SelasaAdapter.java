...
public class SelasaAdapter extends FirebaseRecyclerAdapter<model_jadwal, SelasaAdapter.myviewholder>
{

    public SelasaAdapter(@NonNull FirebaseRecyclerOptions<model_jadwal> options) {
        super(options);
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_jadwal_selasa,parent,false);
