...
public class KamisAdapter extends FirebaseRecyclerAdapter<model_jadwal, KamisAdapter.myviewholder>
{

    public KamisAdapter(@NonNull FirebaseRecyclerOptions<model_jadwal> options) {
        super(options);
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_jadwal_kamis,parent,false);
