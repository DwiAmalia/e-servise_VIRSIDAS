...
public class RabuAdapter extends FirebaseRecyclerAdapter<model_jadwal, RabuAdapter.myviewholder>
{

    public RabuAdapter(@NonNull FirebaseRecyclerOptions<model_jadwal> options) {
        super(options);
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_jadwal_rabu,parent,false);
