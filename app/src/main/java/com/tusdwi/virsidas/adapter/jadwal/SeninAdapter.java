...
public class SeninAdapter extends FirebaseRecyclerAdapter<model_jadwal, SeninAdapter.myviewholder>
{

    public SeninAdapter(@NonNull FirebaseRecyclerOptions<model_jadwal> options) {
        super(options);
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_jadwal_senin,parent,false);
